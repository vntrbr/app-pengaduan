    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                <h2>RIWAYAT LAPORAN <em>PENGADUAN</em></h2>
                
                                    
                                    <p class="text-subtitle text-muted">DATA RIWAYAT LAPORAN </p>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <a href="{{ route('riwayat.index') }}">
                                                <button type="submit"
                                                                        class="main-button">Respon</button>
                                            </a>
                                            <a href="/input">
                                                <button type="submit"
                                                                        class="main-button">Refresh</button>
                                            </a>
                                            <a href="/">
                                                <button type="submit"
                ...
                <input type="text" name="search" class="submit-1" id="search" placeholder="Masukkan NIK">
                <button type="submit" class="main-button    ">Cari</button>
                                    ...
                                    @endphp
                                                            ...
                                                            @foreach ($inputaspirasi as $inputaspirasi)
                                                            


                                                            <tr>
                                                                <td style="text-align: center;">{{ $inputaspirasi->id_pelaporan }}</td>
